...
class RoundnessSettings(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        ArmL.prop(rig.pose.bones["CTRL-UpperArm.L"], '["Smooth - Viewport Arm.L"]', toggle=True, icon="RESTRICT_VIEW_OFF", icon_only= True)
        ArmL.prop(rig.pose.bones["CTRL-UpperArm.L"], '["Smooth - Render Arm.L"]', toggle=True, icon="RESTRICT_RENDER_OFF", icon_only= True)
        ...
        ArmR.prop(rig.pose.bones["CTRL-UpperArm.R"], '["Smooth - Viewport Arm.R"]', toggle=True, icon="RESTRICT_VIEW_OFF", icon_only= True)
        ArmR.prop(rig.pose.bones["CTRL-UpperArm.R"], '["Smooth - Render Arm.R"]', toggle=True, icon="RESTRICT_RENDER_OFF", icon_only= True)
