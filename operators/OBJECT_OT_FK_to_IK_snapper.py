...
class OBJECT_OT_FK_to_IK_snapper(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # Upper First
        Arm_L_IK_bones = ['MCH-UpperArm.L', 'MCH-IK-LowerArm.L']
        Arm_L_FK_bones = ['CTRL-FK-UpperArm.L', 'CTRL-LowerArm.L']

        Arm_R_IK_bones = ['MCH-UpperArm.R', 'MCH-IK-LowerArm.R']
        Arm_R_FK_bones = ['CTRL-FK-UpperArm.R', 'CTRL-LowerArm.R']
        ...
        Arm_IK = bpy.context.active_object.pose.bones["CTRL-LowerArm.L"]
        data = "IK Arm L"
        data_path = '["IK Arm L"]'
        ...
        if self.limb == 'Arm_R':
            ...
            Arm_IK = bpy.context.active_object.pose.bones["CTRL-LowerArm.R"]
            data = "IK Arm R"
            data_path = '["IK Arm R"]'
