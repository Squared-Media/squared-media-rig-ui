...
def drawEyeSettings(self, context):
    ...
    if rig.pose.bones["WGT-UIProperties"]["EyeRigConf"]:
        ...
        DynamicEyes.prop(
            rig.pose.bones["DEF-Pupil.L"], '["Dynamic Eye L"]', toggle=True
        )
        DynamicEyes.prop(
            rig.pose.bones["DEF-Pupil.R"], '["Dynamic Eye R"]', toggle=True
        )
...
def drawArmSettings(self, context):
    ...
    if rig.pose.bones["WGT-UIProperties"]["ArmRigConf"]:
        ...
        col.prop(
            rig.pose.bones["CTRL-HandAttachment.L"],
            '["Parent to Arm"]',
            text="Parent to Arm L",
        )
        col.prop(
            rig.pose.bones["CTRL-HandAttachment.R"],
            '["Parent to Arm"]',
            text="Parent to Arm R",
        )
...
def drawBodySettings(self, context):
    ...
    if rig.pose.bones["WGT-UIProperties"]["BodyConf"]:
        ...
        col.label(text="Body")
        col.prop(
            rig.pose.bones["CTRL-Torso"],
            '["InheritRotation"]',
            toggle=True,
            text="Torso Inherit Rotation",
        )
        col.prop(
            rig.pose.bones["CTRL-Head"],
            '["InheritRotation"]',
            toggle=True,
            text="Head Inherit Rotation",
        )
        col.prop(
            rig.pose.bones["CTRL-Pelvis"], '["HipBone"]', toggle=True, text="Hip Bone"
        )
...
def drawRoundnessSettings(self, context):
    ...
    if rig.pose.bones["WGT-UIProperties"]["RoundnessConf"]:
        ...
        split.prop(
            rig.pose.bones["Settings"],
            '["subd_viewport"]',
            toggle=True,
            icon="RESTRICT_VIEW_OFF"
            if rig.pose.bones["Settings"]["subd_viewport"]
        ...
        split.prop(
            ...
            if rig.pose.bones["Settings"]["subd_render"]
        ...
        SubDBox.prop(
            rig.pose.bones["Settings"],
            '["subd_viewport_res"]',
            text="Viewport Subdivisions",
        )
        SubDBox.prop(
            rig.pose.bones["Settings"],
            '["subd_render_res"]',
            text="Render Subdivisions",
        )
