...
class VIEW3D_PT_visibility_settings(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        # Face Visibility
        col.prop(
            rig.data.collections_all["Isolate Face"],
            "is_visible",
            text="Isolate Face",
            toggle=True,
        ...
        row.prop(
            rig.data.collections_all["FaceSimple"],
            "is_visible",
            text="Face Simple",
            toggle=True,
        )
        row.prop(
            rig.data.collections_all["FaceComplex"],
            "is_visible",
            text="Face Complex",
            toggle=True,
        )
        ...
        col.prop(
            layers["Debug"], "is_visible", text="Debug", toggle=True, icon="SETTINGS"
        )
