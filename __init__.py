...
from .operators.COLLECTION_OT_import_rig_collection import (
    COLLECTION_OT_import_rig_collection,
)
from .operators.SCENE_OT_Open_Preset import (
...
from .operators.OBJECT_OT_keyframe_all_properties import (
